...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    /**
     * A function to determine if the given name is unique (should return "true")
     * or not (should return "false").
     * @callback uniqueNameCallback
     * @param {string} name Base name.
     * @returns {boolean} "true" if the name is considered unique, "false" if not.
     */
     ...
     * @param {string} name Base name.
     * @param {uniqueNameCallback} isUniqueCb Callback function to test names for
     * uniqueness.
     * @returns {string} The resulting unique name in the form of "nameN" where
     * N = 2,3,4...
     */
     ...
     * @returns {string} New unique object name.
     */
...
handleAnnot(true, '', 'IB Dir Beta Tester', 'Beta tester', 'poi1', undefined);
handleAnnot(true, '', 'IB Dir Worker 1', 'Programmer 1', 'poi2', undefined);
handleAnnot(true, '', 'IB Dir Worker 2', 'Programmer 2', 'poi3', undefined);
handleAnnot(true, '', 'IB Dir Client', 'Client', 'poi4', undefined);
handleAnnot(true, '', 'IB Dir Meeting Room', 'Meeting Room', 'poi5', undefined);
...
operateAnimation('PLAY', getAnimations(['GROUP', 'Rubik']), 0, 100, 'LoopPingPong', 1,
        function() {}, false);
